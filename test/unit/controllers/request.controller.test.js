...
describe("Controller - Request", function () {
  describe(".parameter_required()", function () {
    it("should return an error when the specified parameter is not provided", function () {
      controller_request.parameter_required("body", "foo")(
        {},
        {},
        function (error) {
          error.should.have
            .property("message")
            .and.equal('Parameter "foo" is required');
        },
      );

      controller_request.parameter_required("params", "bar")(
        {},
        {},
        function (error) {
          error.should.have
            .property("message")
            .and.equal('Parameter "bar" is required');
        },
      );
    });
